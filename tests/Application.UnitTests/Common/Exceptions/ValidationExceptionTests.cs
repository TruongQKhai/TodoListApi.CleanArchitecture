...
namespace TodoListApiCA.Application.UnitTests.Common.Exceptions;
...
public class ValidationExceptionTests
{
    ...
    [Test]
    public void MultiplesValidationFailureForMultiplePropertiesCreatesAMultipleElementErrorDictionaryEachWithMultipleValues()
    {
        var failures = new List<ValidationFailure>
        {
